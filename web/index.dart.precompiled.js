...
function dart_precompiled($collectedClasses) {
  ...
  function InfoWindowOptions($$unsafe) {
    this.$$unsafe = $$unsafe;
  }
  InfoWindowOptions.builtin$cls = "InfoWindowOptions";
  if (!"name" in InfoWindowOptions)
    InfoWindowOptions.name = "InfoWindowOptions";
  $desc = $collectedClasses.InfoWindowOptions;
  if ($desc instanceof Array)
    $desc = $desc[1];
  InfoWindowOptions.prototype = $desc;
  ...
  function MarkerOptions($$unsafe) {
    this.$$unsafe = $$unsafe;
  }
  MarkerOptions.builtin$cls = "MarkerOptions";
  if (!"name" in MarkerOptions)
    MarkerOptions.name = "MarkerOptions";
  $desc = $collectedClasses.MarkerOptions;
  if ($desc instanceof Array)
    $desc = $desc[1];
  MarkerOptions.prototype = $desc;
  function DirectionsRenderer(_onDirectionsChanged, $$unsafe) {
    this._onDirectionsChanged = _onDirectionsChanged;
    this.$$unsafe = $$unsafe;
  }
  DirectionsRenderer.builtin$cls = "DirectionsRenderer";
  if (!"name" in DirectionsRenderer)
    DirectionsRenderer.name = "DirectionsRenderer";
  $desc = $collectedClasses.DirectionsRenderer;
  if ($desc instanceof Array)
    $desc = $desc[1];
  DirectionsRenderer.prototype = $desc;
  function DirectionsRequest($$unsafe) {
    this.$$unsafe = $$unsafe;
  }
  DirectionsRequest.builtin$cls = "DirectionsRequest";
  if (!"name" in DirectionsRequest)
    DirectionsRequest.name = "DirectionsRequest";
  $desc = $collectedClasses.DirectionsRequest;
  if ($desc instanceof Array)
    $desc = $desc[1];
  DirectionsRequest.prototype = $desc;
  function DirectionsResult($$unsafe) {
    this.$$unsafe = $$unsafe;
  }
  DirectionsResult.builtin$cls = "DirectionsResult";
  if (!"name" in DirectionsResult)
    DirectionsResult.name = "DirectionsResult";
  $desc = $collectedClasses.DirectionsResult;
  if ($desc instanceof Array)
    $desc = $desc[1];
  DirectionsResult.prototype = $desc;
  function DirectionsService($$unsafe) {
    this.$$unsafe = $$unsafe;
  }
  DirectionsService.builtin$cls = "DirectionsService";
  if (!"name" in DirectionsService)
    DirectionsService.name = "DirectionsService";
  $desc = $collectedClasses.DirectionsService;
  if ($desc instanceof Array)
    $desc = $desc[1];
  DirectionsService.prototype = $desc;
  function DirectionsService_route_closure(callback_0) {
    this.callback_0 = callback_0;
  }
  DirectionsService_route_closure.builtin$cls = "DirectionsService_route_closure";
  if (!"name" in DirectionsService_route_closure)
    DirectionsService_route_closure.name = "DirectionsService_route_closure";
  $desc = $collectedClasses.DirectionsService_route_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  DirectionsService_route_closure.prototype = $desc;
  function DirectionsStatus(value) {
    this.value = value;
  }
  DirectionsStatus.builtin$cls = "DirectionsStatus";
  if (!"name" in DirectionsStatus)
    DirectionsStatus.name = "DirectionsStatus";
  $desc = $collectedClasses.DirectionsStatus;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ...
  TravelMode.builtin$cls = "TravelMode";
  if (!"name" in TravelMode)
    TravelMode.name = "TravelMode";
  $desc = $collectedClasses.TravelMode;
  if ($desc instanceof Array)
    $desc = $desc[1];
  TravelMode.prototype = $desc;
  ...
  function findIn_closure(o_0) {
    this.o_0 = o_0;
  }
  findIn_closure.builtin$cls = "findIn_closure";
  if (!"name" in findIn_closure)
    findIn_closure.name = "findIn_closure";
  $desc = $collectedClasses.findIn_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  findIn_closure.prototype = $desc;
  function findIn_closure0() {
  }
  findIn_closure0.builtin$cls = "findIn_closure0";
  if (!"name" in findIn_closure0)
    findIn_closure0.name = "findIn_closure0";
  $desc = $collectedClasses.findIn_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  findIn_closure0.prototype = $desc;
